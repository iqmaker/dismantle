""" Google Transliterate API : pyGoogleTransliterate
A pythonic wrapper over the google transliteration API.This works by sending a GET Request and parsing the json response.
website: http://tech.pradeepnayak.in
Usage:
import pyGoogleTransliterate
output = pyGoogleTransliterate.Transliterate('hi') #Transliterate from english to hindi
print output.getTransliteration("Mera Bharath Mahan") 

"""
from __future__ import generators
__author__ = "Pradeep Nayak"
__email__ = "pradeep1288@gmail.com"
__version__ = "1.0.0a"
